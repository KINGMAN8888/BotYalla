...
sequenceDiagram
    ...
    P-->>C: رسالة تحتها زر «✨ أنشئ بوتي» (رابط t.me/newbot)
    C->>T: يضغط الزر ← شاشة إنشاء البوت ← يأكّد الاسم واليوزر
...
- [ ] **السيرفر محدَّث**:
      ...
      ```
      (بيسحب آخر نسخة من GitHub، يثبّت المكتبات، يبني الواجهة، ويعيد تشغيل الخدمة.)
      المكتبة المطلوبة `python-telegram-bot==22.8`.
...
4. تليجرام هيفتح بوت المنصة ويبعتلك رسالة، **تحت الرسالة نفسها** زرّ **«✨ أنشئ بوتي»** ← اضغطه.
5. تليجرام يفتح شاشة إنشاء البوت: **الاسم واليوزر جاهزين** (تقدر تعدّلهم) ← **Create**.
...
| الضغط على «أنشئ بوتي» بيفتح شاشة **«Forward»** فاضية (بطة بتدوّر) | زرّ لوحة المفاتيح القديم (تحت خانة الكتابة) من نسخة المنصة قبل 2026-09-13 — تليجرام iOS بيفتحه كقائمة محادثات بدل شاشة الإنشاء | حدّث السيرفر (القسم 2)، وابدأ من اللوحة من جديد، واضغط الزر اللي **تحت الرسالة** مش اللي تحت خانة الكتابة. الزر القديم بيختفي بعد أول إنشاء ناجح |
| الرابط بيفتح محادثة @NewBot بدل شاشة الإنشاء (تليجرام ماك) | باگ معروف في تليجرام macOS ([bugs.telegram.org/c/60634](https://bugs.telegram.org/c/60634)) | افتح الرابط من الموبايل (امسح الـQR) |
| زر «✨ أنشئ بوتي» بيفتح رسالة إن الرابط مش مدعوم | تطبيق تليجرام قديم (الميزة من أبريل 2026) | حدّث التطبيق |
