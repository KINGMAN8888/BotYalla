...
- **فك الربط:** «حسابي» ← «طرق الدخول» ← «فك الربط». آخر طريقة دخول لحساب بلا كلمة مرور لا تُفك (كان سيُقفل برّا حسابه). وبعد الفك لا يرجع الربط تلقائياً لو دخل بنفس الحساب — يربطه صراحةً من «حسابي».
