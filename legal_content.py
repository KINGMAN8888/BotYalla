  ...
  {"id": "service", "h": {"ar": "2. وصف الخدمة", "en": "2. The service"},
   "body": {
    "ar": ["تتيح المنصة إنشاء بوتات محادثة وإدارتها على تليجرام، وعلى واتساب عبر WhatsApp Cloud API الرسمي من Meta، دون برمجة: باني محادثات، قوالب جاهزة، إعداد بمساعدة الذكاء الاصطناعي، استقبال الطلبات والحجوزات وبيانات العملاء، حملات، وتحليلات.",
           ["بوت تليجرام تنشئه أنت من BotFather الرسمي ثم تربط توكنه بالمنصة — تليجرام لا يسمح بإنشاء البوتات تلقائياً.",
    ...
    "en": ["The platform lets you build and manage chatbots on Telegram, and on WhatsApp through Meta’s official WhatsApp Cloud API, without code: a conversation builder, ready-made templates, AI-assisted setup, orders, bookings and customer data, campaigns, and analytics.",
           ["You create a Telegram bot yourself through the official BotFather and connect its token to the platform — Telegram does not allow bots to be created automatically.",
...
"privacy": {
 ...
 "sections": [
  ...
  {"id": "collect", "h": {"ar": "2. البيانات التي نجمعها", "en": "2. What we collect"},
   "body": {
    "ar": [["بيانات الحساب: اسم المستخدم، البريد الإلكتروني (اختياري)، كلمة المرور مخزّنة مشفّرة لا نصاً، تفضيل اللغة.",
    ...
    "en": [["Account data: username, email (optional), your password stored hashed never in plain text, language preference.",
  ...
  {"id": "purposes", "h": {"ar": "4. لماذا نستخدمها", "en": "4. Why we use it"},
   "body": {
    "ar": [["تقديم الخدمة وتشغيل بوتاتك وتنفيذ اشتراكك — لتنفيذ العقد بيننا.",
            ...
            "رسائل تشغيلية بالبريد (استرجاع كلمة المرور، إيصالات الدفع، الترحيب، تذكير انتهاء الاشتراك). لا نرسل رسائل تسويقية دون موافقتك."]],
    "en": [["Providing the service, running your bots and fulfilling your subscription — to perform our contract.",
            ...
            "Operational emails (password reset, payment receipts, welcome, expiry reminders). We send no marketing emails without your consent."]]}},
  {"id": "sharing", "h": {"ar": "5. مع من نشاركها", "en": "5. Who we share it with"},
   "body": {
    "ar": ["لا نبيع بياناتك ولا نؤجرها. نشاركها فقط مع من يلزم لتشغيل الخدمة:",
           ["تليجرام — لتشغيل بوتاتك عبر Bot API.",
            "Meta (واتساب) — لإرسال رسائل بوتك واستقبالها عبر WhatsApp Cloud API.",
            "مزوّدو الذكاء الاصطناعي (Google Gemini أو Groq) — حين تستخدم الإعداد بالذكاء الاصطناعي فقط، ونرسل وصف نشاطك لا بيانات عملائك.",
            "مزوّد الاستضافة الذي يعمل عليه الخادم، ومزوّد البريد الإلكتروني لرسائل التشغيل.",
    ...
    "en": ["We do not sell or rent your data. We share it only with those needed to run the service:",
           ["Telegram — to run your bots through the Bot API.",
            "Meta (WhatsApp) — to send and receive your bot’s messages through the WhatsApp Cloud API.",
            "AI providers (Google Gemini or Groq) — only when you use AI setup, and we send your business description, not your customers’ data.",
            "The hosting provider running our server, and the email provider for operational emails.",
  ...
  {"id": "retention", "h": {"ar": "7. مدة الاحتفاظ", "en": "7. How long we keep it"},
   "body": {
    "ar": [["بيانات الحساب والبوتات: طوال بقاء الحساب، وتُحذف خلال 30 يوماً من طلب الحذف أو إنهاء الحساب.",
            ...
            "بيانات عملائك النهائيين: حتى تحذفها أنت أو يُحذف البوت أو الحساب. الوسائط التي لم ترتبط بطلب مكتمل تُحذف تلقائياً بعد 7 أيام.",
    ...
    "en": [["Account and bot data: for as long as the account exists, deleted within 30 days of a deletion request or account termination.",
            ...
            "Your end customers’ data: until you delete it or the bot or account is deleted. Media not attached to a completed request is deleted automatically after 7 days.",
