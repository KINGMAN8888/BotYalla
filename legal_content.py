...
"privacy": {
 ...
 "sections": [
  ...
  {"id": "collect", "h": {"ar": "2. البيانات التي نجمعها", "en": "2. What we collect"},
   "body": {
    "ar": [["بيانات الحساب: اسم المستخدم، البريد الإلكتروني ورقم الهاتف (وحالة تأكيدهما)، السن، نوع الحساب (فرد · شركة · مؤسسة)، كلمة المرور مخزّنة مشفّرة لا نصاً، تفضيل اللغة، وصورة الحساب أو لوجو النشاط إن رفعتها. ولو سجّلت بجوجل أو فيسبوك: معرّف حسابك لديهما وبريدك واسمك فقط — لا نرى كلمة مرورك عندهما ولا ننشر شيئاً باسمك.",
    ...
    "en": [["Account data: username, email and phone number (and whether they are verified), age, account type (individual · company · institution), your password stored hashed never in plain text, language preference, and your profile picture or business logo if you upload one. If you sign up with Google or Facebook: only your account ID there, your email and your name — we never see your password there and never post on your behalf.",
