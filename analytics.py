...
الوضعان:
  • `GTM_ID` مضبوط  → يُحقن GTM **وحده**، وبقية المعرّفات تُقرأ لتوسيع CSP فقط
                      (توضع وسومها داخل حاوية GTM). لا ازدواج في الإرسال.
  • `GTM_ID` فارغ    → كل أداة مضبوطة تُحقن بسكربتها المباشر.
